      ...
      <main>
        ...
        <section className="bg-[#fbf8f1] py-20 lg:py-28">
          <div className="mx-auto max-w-[1380px] px-5 md:px-10 lg:px-14">
            ...
            <div className="mt-14 grid auto-rows-[300px] gap-5 md:grid-cols-2 md:auto-rows-[330px] lg:grid-cols-4">
            ...
            <div className="mt-16 border border-[#5a0c1d]/10 bg-[#f1eadf] p-8 text-center md:p-12">
