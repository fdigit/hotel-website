  ...
  return (
    <>
      ...
      <main className="flex min-h-[75vh] items-center bg-[#fbf8f1] px-5 pb-20 pt-32">
        <Reveal className="mx-auto w-full max-w-3xl border border-black/8 bg-white p-6 text-center shadow-[0_24px_80px_rgba(44,20,12,.08)] sm:p-8 md:p-14">
          ...
          <h1 className="mt-4 font-headline-lg text-[36px] leading-tight text-[#321017] sm:text-[42px] md:text-[56px]">Let&apos;s confirm your stay together.</h1>
