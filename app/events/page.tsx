  ...
  return (
    <>
      ...
      <main>
          ...
          <Reveal className="mx-auto max-w-[1380px] px-5 md:px-10 lg:px-14">
            <div className="grid gap-12 lg:grid-cols-[.85fr_1.15fr] lg:gap-24">
              <div>
                ...
                <h2 className="mt-5 font-headline-lg text-[36px] leading-[1.1] text-[#321017] sm:text-[42px] md:text-[58px]">Plans made personal.</h2>
                ...
                <a href={whatsappUrl("Hello JAVIN Hotels, I would like to discuss an event or private occasion.")} target="_blank" rel="noreferrer" className="mt-8 inline-flex w-full rounded-full bg-[#5a0c1d] px-6 py-4 text-xs font-extrabold uppercase tracking-[0.12em] text-white min-[430px]:w-auto sm:px-8 sm:tracking-[0.15em]">Start an event enquiry</a>
              </div>
        ...
        <section className="bg-[#271714] py-16 text-white sm:py-20 lg:py-28">
          <Reveal className="mx-auto grid max-w-[1380px] items-center gap-12 px-5 md:px-10 lg:grid-cols-2 lg:px-14">
            ...
            <div className="lg:pl-12">
              ...
              <h2 className="mt-5 font-headline-lg text-[36px] leading-tight sm:text-[42px] md:text-[56px]">Tell us what you are planning.</h2>
