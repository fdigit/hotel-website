  ...
  return (
    <>
      ...
      <main className="bg-[#fbf8f1] pt-20">
        <section className="mx-auto max-w-[1380px] px-5 py-6 sm:py-10 md:px-10 lg:px-14 lg:py-14">
          <div className="relative min-h-[500px] overflow-hidden bg-[#241613] sm:min-h-[620px]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-5 text-white sm:p-7 md:p-12 lg:p-16">
              <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#e0bc70]">An elevated stay</p>
              <h1 className="mt-4 max-w-3xl font-display-lg text-[40px] leading-[1.08] sm:text-[48px] md:text-[72px]">The Executive experience.</h1>
              <p className="mt-4 max-w-xl text-[15px] leading-7 text-white/80 sm:mt-5 sm:text-base sm:leading-8">Extra room to settle in, work comfortably and make more of your time in Port Harcourt.</p>
            </div>
          </div>
        </section>
        <section className="py-16 lg:py-24">
          <Reveal className="mx-auto grid max-w-[1100px] gap-12 px-5 md:px-10 lg:grid-cols-[1fr_.65fr]">
            <div>
              ...
              <h2 className="mt-4 font-headline-lg text-[36px] leading-tight text-[#321017] sm:text-[42px] md:text-[54px]">Designed for more time, more ease.</h2>
            ...
            <div className="bg-[#efe8dc] p-6 sm:p-8">
